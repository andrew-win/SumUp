                ...
                val instance = Room.databaseBuilder(
                    ...
                    .addCallback(object : Callback() {
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            db.execSQL(
                                "INSERT OR IGNORE INTO user_preferences (id, aiStrategy, isScheduledSummaryEnabled, scheduledHour, scheduledMinute, lastWorkRunTimestamp, isDeduplicationEnabled, deduplicationThreshold, minMentions, isImportanceFilterEnabled, extractiveSentencesInFeed, extractiveSentencesInScheduled, extractiveNewsInScheduled, isHideSingleNewsEnabled, aiMaxCharsPerArticle, aiMaxCharsPerFeedArticle, aiMaxCharsTotal) " +
                                "VALUES (0, 'ADAPTIVE', 0, 8, 0, 0, 0, 0.6, 2, 1, 3, 5, 10, 1, 1000, 1000, 12000)"
                            )
                        }
                    })
                    .build()
