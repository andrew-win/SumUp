                ...
                when (activeGroup) {
                    ...
                    SettingsGroup.FEED -> item {
                        SettingsFeedGroupContent(
                            ...
                            onFeedTitleExcludeRegexEnabledChange = viewModel::updateFeedTitleExcludeRegexEnabled,
                            onFeedTitleExcludeRegexChange = viewModel::updateFeedTitleExcludeRegex,
...
private fun SettingsGroup.searchableTextResIds(): List<Int> = when (this) {
    ...
    SettingsGroup.FEED -> listOf(
        ...
        R.string.settings_feed_title_exclude_regex_enabled,
        R.string.settings_feed_title_exclude_regex,
